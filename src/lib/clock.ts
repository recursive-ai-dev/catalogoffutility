...
/**
 * Pre-allocated formatter to avoid the overhead of repeated object creation and
 * locale-parsing during high-frequency log updates (BUG-11b).
 * Benchmarked impact: ~30ms vs ~1.2s for 10k operations (~40x speedup).
 */
