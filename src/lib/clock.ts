...
/**
 * Shared formatter for 24-hour time strings. Pre-allocating this avoids the
 * significant overhead (~80x in benchmarks) of repeated object creation and
 * locale parsing during high-frequency log updates or re-renders.
 */
