            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-3 bg-black/50 border border-white/8 focus-within:border-white/20 rounded-lg px-4 py-3 transition-colors">
                ...
                <button
                  ...
                  className="flex items-center justify-center text-white/20 hover:text-white/50 transition-colors cursor-pointer focus-visible:ring-1 focus-visible:ring-white/30 outline-none rounded-sm"
