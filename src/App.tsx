...
function AppInner() {
  ...
  // Performance: Lifting and memoizing specific auth fields prevents the entire
  // Catalog tree from re-rendering on non-UI-impacting auth context updates
  // (e.g. background session refreshes or metadata changes).
