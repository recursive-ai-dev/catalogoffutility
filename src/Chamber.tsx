...
/**
 * Individual log entry item. Memoized to prevent re-renders when the logs list shifts
 * or adds new entries. Stable `log.id` key in the parent list ensures React only
 * renders new entries.
 */
const LogEntryItem = React.memo(({ log }: { log: LogEntry }) => (
  <div
