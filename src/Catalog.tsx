...
/**
 * Pre-calculated lists of navigable entries for authenticated and anonymous users.
 * Enables O(1) random selection in handleWasteTime.
 */
...
export const Catalog = React.memo(function Catalog({
  ...
  // Optimized O(1) random navigation — uses pre-calculated navigable lists to
  // avoid O(N) filtering during every interaction.
