...
/**
 * Optimized regex for initials extraction.
 * Captures the first character and any character following a separator (._- or space).
 */
...
export const Catalog = React.memo(function Catalog({
  ...
  // Normalize the query before deferring to avoid redundant work for non-functional
  // changes (like adding/removing trailing spaces).
