...
import { initials, PROFILE_DATE_FORMATTER } from "./lib/auth";
...
// Pre-calculate navigable entry lists for O(1) random navigation selection.
// Reduces main-thread work by avoiding O(N) filtering on every "Waste Time" click.
