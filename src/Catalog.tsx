...
/**
 * Pre-compiled regex for initials extraction.
 * Optimized to match characters following boundaries (start, dot, underscore, dash, space).
 */
...
export const Catalog = React.memo(function Catalog({
  ...
  // Chain 1 (BrowseFilter): normalize query in useMemo before passing to deferred value.
  // This ensures filteredEntries useMemo only re-calculates when the *effective*
  // search intent changes (ignoring trailing spaces or casing changes).
