...
import { useAuthModal, EMAIL_CLEAN_REGEX, initials } from "./lib/auth";
...
/**
 * Pre-calculate lists of navigable apps for the "Waste Time" feature.
 * This allows O(1) random selection during interaction, bypassing O(N) filtering.
 */
