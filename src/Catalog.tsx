...
// Pre-calculate navigable entry lists to make random selection O(1) during interaction.
...
const UserSection = React.memo(function UserSection({
  ...
  const displayName = userDisplayName ?? "entity";
    ...
    <div className="w-full md:w-72 shrink-0 flex flex-col border-b md:border-b-0 md:border-r border-white/10 bg-black/40 backdrop-blur-xl z-20">
      ...
      <nav className="flex-1 overflow-y-auto py-6 px-4 flex flex-col gap-2">
        <button
          ...
          onClick={() => {
            // Performance: Use pre-calculated navigable lists to make random selection O(1).
