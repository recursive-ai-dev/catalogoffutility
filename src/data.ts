...
export const CATALOG_ENTRIES: AppEntry[] = [
  ...
  },
  {
    ...
    longDescription: `There are 26 fundamental concepts. Each contains multitudes.\n\nSOUL MIRROR is a contemplation tool built around a symbolic system of human experience. Each concept — Agency, Balance, Connection, Discovery, and 22 others — represents a dimension of existence. Selecting a concept reveals its five shades — the nuances and associated meanings that cluster around the core idea — alongside a short reflection on what the concept means when examined closely.\n\nThe interface is dark and minimal. The purpose is contemplation.\n\nYou can explore concepts in any order. The mirror remembers your selections — which concepts you have visited, how many times, and when. A progress bar traces the map of your contemplation as it builds across sessions. The data lives locally in your browser and persists between visits.\n\nThis is not a personality test. It is not a therapeutic tool. It is a mirror — an interface for examining the conceptual architecture of human experience. What you see in it depends on what you bring to it.\n\nSelect a concept. Watch the shades emerge. The mirror is already watching.`,
    size: "58 KB",
  ...
  },
  {
    ...
    longDescription: `At the quantum scale, certainty dissolves. Probability reigns.\n\nQUANTUM ANT is an ambient 3D particle visualization rendered in Three.js. Five hundred particles orbit a central field, their positions animated with layered noise and orbital drift. The interface displays three aesthetic metrics — quantum phase, coherence, and entanglement depth — each oscillating with its own rhythm.\n\nThis is not a scientific simulation. The metrics are aesthetic, not mathematical. The visualization is inspired by quantum concepts — coherence, entanglement, phase — rather than derived from them. It is a rendering of what quantum consciousness might look like if it could be seen. The atmosphere is genuine. The science is metaphorical.\n\nThe orbit controls respond to mouse and touch input: drag to rotate the view, scroll to zoom. The field breathes and shifts on its own. You are not expected to do anything. You are only expected to watch.\n\nThe simulation continues. The particles drift. The phase cycles. The void is full of motion you cannot stop and did not cause.`,
    size: "42 KB",
    tags: ["Simulation", "Endless"],
