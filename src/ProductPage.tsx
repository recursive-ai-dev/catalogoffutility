              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {app.tags.map((tag) => (
                  <button
                    ...
                    className="px-3 py-1 border border-white/10 text-white/35 hover:text-white/60 hover:border-white/30 text-[9px] font-mono tracking-widest uppercase rounded-full transition-colors cursor-pointer focus-visible:ring-1 focus-visible:ring-white/30 outline-none"
                  >
                    {tag}
                  </button>
                ))}
